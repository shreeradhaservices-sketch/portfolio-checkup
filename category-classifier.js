...
const FINE_CATEGORIES = {
  ...
  'Value / Contra': ['value fund', 'value plan', 'contra fund'],
  'Focused': ['focused fund', 'focused plan'],
  'ELSS': ['elss', 'tax saver', 'tax plan'],
  'Sectoral': ['banking and financial', 'banking & financial', 'banking fund', 'psu fund', 'infrastructure fund', 'pharma fund', 'healthcare fund', 'technology fund', 'digital fund', 'fmcg fund', 'auto fund', 'realty fund', 'energy fund', 'manufacturing fund'],
  'Thematic': ['thematic', 'business cycle', 'special situations', 'mnc fund', 'consumption fund', 'dividend yield', 'rural fund', 'esg fund', 'quant fund'],
  'Hybrid': ['hybrid fund', 'balanced advantage', 'balanced fund', 'equity savings', 'arbitrage fund'],
  'Multi-Asset': ['multi asset', 'multi-asset'],
  'Gold / Silver': ['gold fund', 'gold savings', 'gold etf', 'gold bees', 'gold and silver', 'silver etf'],
  'Debt': ['debt fund', 'short term', 'long term bond', 'gilt fund', 'liquid fund', 'liquid bees', 'liquid etf', 'corporate bond', 'banking and psu', 'banking fd', 'credit risk', 'money market', 'ultra short', 'low duration', 'dynamic bond', 'income fund']
};

const BROAD_CATEGORIES = {
  'Equity': ['Large & Mid Cap', 'Large Cap', 'Mid Cap', 'Small Cap', 'Multi Cap', 'Flexi Cap', 'Value / Contra', 'Focused', 'ELSS', 'Sectoral', 'Thematic'],
  'Hybrid': ['Hybrid'],
